...
<div id="contenido">
    <form id="form" enctype="multipart/form-data" action="<?php echo base_url() . 'aspirantes/create_aspirante'; ?>" id="form" method="post">
        ...
        <div id="insert_form" class="content-center">
            ...
            <div class="row">
                <div class="input">
                    ...
                    <input type="date" name="dt_inscripcion" id="dt_inscripcion" value="<?php echo date('Y-m-d'); ?>" class="required" required/>
                </div>
                <div class="input">
                    <label for="ciclo_lectivo">Ciclo Lectivo:</label>
                    <input type="text" id="ciclo_lectivo" name="ciclo_lectivo" class="required" required/>
                </div>
                <div class="input">
                ...
                <div class="input">
                    ...
                    <input type="text" id="escuela_anterior" name="escuela_anterior" class="required" required/>
                </div>
            </div>
            <div class="subtitle border_top">
                Datos Personales
            ...
            <div class="row border_bottom">
                <div class="input">
                    ...
                    <input type="file" name="image" style="max-width:12em;" id="image" class="image"/>
            ...
            <div id="telefonosContainer" class="border_bottom">
