...
<div id="contenido">    
    ...
    <form id="form" action="<?php echo base_url() . 'aspirantes/add_related_view'; ?>" method="post">
        <div id="insert_form" class="content-center">
            ...
            <div class="row border_top border_bottom" style="vertical-align: bottom">
                ...
                <div class="input" style="padding-top: 20px">
                    ...
                    <input type="hidden" value="<?php if (isset($page)) {
                            echo $page;
                        } else {
                            echo 1;
                        } ?>" name="page" id="page"/>
                    <input type="hidden" value="<?php if (isset($last_page)) {
                            echo $last_page;
                        } else {
                            echo 1;
                        } ?>" name="last_page" id="last_page"/>
