...
<div id="contenido">
    <form id="form" action="<?php echo base_url() . 'aspirantes/convertir_en_alumnos'; ?>" method="post">

        <div style="width:90%; margin: auto;">
            Fecha de inscripción como alumnos: <input type="date" value="<?php echo date('Y-m-d'); ?>" name="dt_ingreso">
            ...
            <div class="row">
                <button onclick="return aspiranteView.submitForm('form', true)">Admitir</button>
