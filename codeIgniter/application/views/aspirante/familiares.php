...
<div >
    <table class="content-center tablesorter" id="myTable">
        ...
        <tbody>
            ...
            foreach ($aspirante->persona->persona_es as $vinculo) {
                $i++;
                include("familiares_row.php");
            }
            foreach ($aspirante->persona->persona_de as $vinculo) {
                $i++;
                include("familiares_row.php");
            }
            ?>
...
<div id="insert_form" class="content-center" >
    ...
    <div class="row">
<?php echo form_open("aspirantes/add_related/" . $aspirante->persona->id); ?>
        <div class="input_grande">
            ...
            <div id="icons" style="float: left">
                <a href="<?php echo base_url(); ?>aspirantes/add_related_view" target="_blank"><li class="ui-state-default ui-corner-all" title="Seleccionar" ><span class="ui-icon ui-icon-search" style="margin: 0 4px;"></span></li></a>
            </div>                                        
