...
<div id="tabs" style="width: 100%">
    <ul>
        <li><a href="#tabs-1">Nuevo Adelanto</a></li>
    </ul>
    <div id="tabs-1">
        <?php echo form_open_multipart('personales/addAdelanto/' . $persona_id); ?>
        <div id="insert_form" >        
            <div class="row">            
                <div class="input">
                    <input type="hidden"  name="persona_id" value="<?php echo $persona_id; ?>" />
                    <label for="dt_adelanto">Fecha:</label>
                    <input type="date" name="dt_adelanto" id="dt_adelanto" />
                </div> 
                <div class="input">
                    <label for="monto">Monto:</label>
                    <input type="text" class="input_chico" name="monto" id="monto" />
                </div> 
                <div class="input">
                    <label for="tipo_adelanto">Tipo:</label>
                    <select id="tipo_adelanto" name="tipo_adelanto">
                ...
                <div class="input">
                    <label for="estado_adelanto">Estado:</label>                    
                    <select   id="estado_adelanto" name="estado_adelanto">
                ...
                <div class="input">
                    <label for="dt_cobro">Fecha Cobro:</label>
                    <input type="date" name="dt_cobro" id="dt_cobro" />
                </div>  
