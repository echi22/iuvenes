        ...
        <div id="insert_form" >        
            ...
            <div class="row">
                <div class="input">
                    ...
                    <input type="text" id="apellidos" name="apellidos" value="<?php echo $alumno->persona->apellidos; ?>" class="required" required/>
                </div>
                <div class="input">
                    <label for="nombres">Nombres:</label>
                    <input type="text" id="nombres" value="<?php echo $alumno->persona->nombres; ?>" name="nombres" class="required" required/>
                </div>
                <div id="prev_image" class="foto_container">
                    <div style="background-image: url(<?php echo base_url() . $alumno->persona->foto; ?>); background-size: contain; background-repeat: no-repeat no-repeat;" class="prev_thumb"></div>
                </div><br/>
        ...
        alumnosView.setSelectedIndexByValue('<?php echo $dom->country->id; ?>', 'dom_pais_<?php echo $i; ?>');
            ...
            <div class="row">
                <div class="input">
                    ...
                    <input type="date" name="dt_nac" id="dt_nac" value="<?php echo $alumno->persona->dt_nac; ?>" class="required" required/>
                </div>
                <div class="input">
