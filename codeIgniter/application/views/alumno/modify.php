        ...
        <div  id="identificaciones">
          ...
          <?php
                ...
                <div id="identificacion" class="row">
                    ...
                    <? }else{ ?>
                    <div class="input" id="icons">
                        <li class="ui-state-default ui-corner-all" title="Eliminar"  onclick="alumnosView.deleteRow('identificacion');"><span class="ui-icon ui-icon-plus" style="margin: 0 4px;"></span></li>
                    </div>
                    <?php } ?>
                </div>
